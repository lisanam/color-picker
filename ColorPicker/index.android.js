...
import ImageEffects from './imageEffects';
    			...
    			// <Scene key="editor" component={ImageEffects} title="Apply Image Effects" />
class ColorPicker extends React.Component {
  render() {
    return (
    	<Router>
    		<Scene key="root">
    			<Scene key="start" component={App} initial={true} title="Coloriz: Analizer" />
    			<Scene key="editor" component={ImageEffects} title='Editor' />
    		</Scene>
    	</Router>
    );
  }
